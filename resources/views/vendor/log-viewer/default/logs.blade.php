...
<div class="card card-custom gutter-b" data-card="true">
  <div class="card-header">
    ...
    <div class="card-toolbar">
      <a href="{{ URL::Current() }}/.." class="btn btn-icon btn-xs btn-hover-light-primary mr-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{ __('default.label.back') }}"><i class="fas fa-arrow-left"></i></a>
